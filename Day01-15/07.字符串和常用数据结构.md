...
def main():
    ...
    # 添加元素
    list1.append(200)
    list1.insert(1, 400)   #(position,element)
    list1 += [1000, 2000]
    print(list1)
    print(len(list1))
    # 删除元素
...
def main():
    ...
    fruits2 = fruits[1:4]
    print(fruits2)
    # fruit3 = fruits  # 没有复制列表只创建了新的引用   后面对fruits操作后，也会影响到f3
    # 可以通过完整切片操作来复制列表
    fruits3 = fruits[:]
    print(fruits3)
    fruits4 = fruits[-3:-1]
...
def main():
    ...
    list2 = sorted(list1)
    # sorted函数返回列表排序后的拷贝不会修改传入的列表  ---数字、字符串按ASCII编码排序，中文unicode排序
    # 函数的设计就应该像sorted函数一样尽可能不产生副作用
    list3 = sorted(list1, reverse=True) #确认反转
    # 通过key关键字参数指定根据字符串长度进行排序而不是默认的字母表顺序-https://www.cnblogs.com/huchong/p/8296025.html
